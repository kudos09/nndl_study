...
class Network(object):
    ...
    def __init__(self, layers, mini_batch_size):
        ...
        #print(init_layer,"cc", self.layers, "\nhh", self.output, "\njj",self.output_dropout)
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,validation_data, test_data, lmbda=0.0):
        ...
        num_training_batches = size(training_data)/(mini_batch_size*10)
        num_validation_batches = size(validation_data)/mini_batch_size
        num_test_batches = size(test_data)/mini_batch_size
        print("1aaa",num_training_batches, "\nbb", num_validation_batches, "\ncc",num_test_batches )
        ...
        best_validation_accuracy = 0.09
        for epoch in range(epochs):
            for minibatch_index in range(int(num_training_batches)):
                iteration = num_training_batches*epoch+minibatch_index
                print("xxx", iteration, "ff", epoch, "jj", num_training_batches)
                if iteration % 1000 == 0:
                ...
                if (iteration+1) % num_training_batches == 0:
                    ...
                    if validation_accuracy >= best_validation_accuracy:
                        ...
                        if test_data:
                            print("ccc", test_data, "nn:", num_test_batches)
